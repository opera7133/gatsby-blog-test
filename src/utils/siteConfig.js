module.exports = {
    ...
    shareImageWidth: 1920, // Change to the width of your default share image
    shareImageHeight: 1080, // Change to the height of your default share image

    shortTitle: `Acto`, // Used for App manifest e.g. Mobile Home Screen
